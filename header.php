...
<body <?php body_class(); ?>>
    ...
    $navbar_blog_pages = ['blog', 'page__blog'];
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse" id="navbarCollapse">
                    <ul id="header" class="navbar-nav me-auto align-items-sm-center pt-1">
                        ...
                        <li class="btn-menu ms-lg-4 mt-3 mt-lg-0"><a href="<?php echo home_url('/temoignages-client/'); ?>">Nos témoignages clients</a></li>
